...
helm.sh/chart: {{ include "sso-server.chart" . }}
...
*/}}
{{- define "sso-server.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "sso-server.fullname" .) .Values.serviceAccount.name }}
{{- else }}
